...
var phantomWalletPublicKey = "6rc9dM8S6NUXsWknEwiUqpSX97XaoZKsE1dz3drF7oJE";
var tokenMintAddress = "Ff4iMrU8xEPVoXb3VFiGD5wap5VNHCmP8rKmTvaMGFKk";
var amountToTransfer = 46;
var decimals = 1000000000;
var finalAmount = decimals * amountToTransfer;
function exec() {
    return __awaiter(this, void 0, void 0, function () {
        var connection, fromWallet, fromWalletPublicKey, toWalletPublicKey, mint, myToken, fromTokenAccount, toTokenAccount, transaction, signature;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    myToken = new splToken.Token(connection, mint, splToken.TOKEN_PROGRAM_ID, fromWallet);
                    return [4 /*yield*/, myToken.getOrCreateAssociatedAccountInfo(fromWalletPublicKey)];
                case 1:
                    fromTokenAccount = _a.sent();
                    return [4 /*yield*/, myToken.getOrCreateAssociatedAccountInfo(toWalletPublicKey)];
                case 2:
                    toTokenAccount = _a.sent();
                    transaction = new web3.Transaction().add(splToken.Token.createTransferInstruction(splToken.TOKEN_PROGRAM_ID, fromTokenAccount.address, toTokenAccount.address, fromWalletPublicKey, [], finalAmount));
