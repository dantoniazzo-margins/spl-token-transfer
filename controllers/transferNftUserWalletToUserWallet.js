...
var fromPublicKey = new web3.PublicKey("2vjtfMMQBSYuimnQjhp8t2QoXWkum8Migqk7t8LmgKjn");
var toPublicKey = new web3.PublicKey("6rc9dM8S6NUXsWknEwiUqpSX97XaoZKsE1dz3drF7oJE");
var mint = new web3.PublicKey("3rJ6LhuUWGuqLyFQQKgc3JSLxgznJ4cSn3qfc2szBuZ4");
...
var fromWallet = web3.Keypair.fromSecretKey(SECRET_KEY, { skipValidation: true });
var finalAmount = 1;
function transferNftFromWalletToWallet(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        var connection, SPL_ASSOCIATED_TOKEN_ACCOUNT_PROGRAM_ID, fromTokenAddress, toTokenAddress, createAssociatedAccountTransaction, transaction, blockhash;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 2:
                    ...
                    createAssociatedAccountTransaction = new web3.Transaction()
                        .add(splToken.createAssociatedTokenAccountInstruction(fromPublicKey, toTokenAddress, toPublicKey, mint, splToken.TOKEN_PROGRAM_ID, splToken.ASSOCIATED_TOKEN_PROGRAM_ID));
                    transaction = new web3.Transaction()
                        .add(splToken.createTransferInstruction(fromTokenAddress, toTokenAddress, fromPublicKey, finalAmount, [], splToken.TOKEN_PROGRAM_ID));
...
exports["default"] = transferNftFromWalletToWallet;
